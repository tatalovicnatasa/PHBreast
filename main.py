...
from utils.utils import (
    compute_classweights,  # Added, function to compute weights for imbalanced dataset
)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=bool,
        default=True,
        help="in case of fourview model: True for shared bottleneck, False for concat version",
    )
    parser.add_argument(
        "--patch_weights",
        type=bool,
        default=True,
        help="True if weights are patch, False if they are whole-image",
    )
